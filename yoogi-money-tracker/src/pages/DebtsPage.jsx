...
import { Users, Plus, ArrowDownToLine, ArrowUpFromLine, Search, ChevronRight, HandCoins } from 'lucide-react';
import { formatCurrency } from '../utils/formatters';
import AddDebtModal from '../components/modals/AddDebtModal';
import RepayDebtModal from '../components/modals/RepayDebtModal';
import { addDebtor } from '../utils/firebaseHelpers';
        ...
        <div className="space-y-6 max-w-5xl mx-auto pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mt-1">Quản lý tiền cho người thân, bạn bè mượn</p>
                </div>
                <div className="flex items-center gap-3">
                    <button
                        onClick={() => setIsAddOpen(true)}
                        className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-slate-800 dark:bg-emerald-600 hover:bg-slate-700 dark:hover:bg-emerald-500 text-white rounded-xl font-bold transition-all shadow-lg shadow-slate-200 dark:shadow-emerald-900/20 active:scale-95"
                    >
