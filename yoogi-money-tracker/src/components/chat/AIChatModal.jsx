...
const AIChatModal = ({ isOpen, onClose, user, categories, aiMemories, wallets, payers, recurringTransactions, selectedWalletId, onOpenContextWallet }) => {
    ...
    return (
        <>
            ...
            {/* Chat Panel */}
            <div className="fixed top-4 bottom-4 right-4 z-50 flex flex-col w-[calc(100%-2rem)] md:w-[400px] lg:w-[450px] bg-slate-50 dark:bg-slate-900 shadow-2xl border border-slate-200 dark:border-slate-800 rounded-3xl animate-in slide-in-from-right duration-300 overflow-hidden">
                {/* Header */}
