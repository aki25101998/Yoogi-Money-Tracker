...
const RecurringTransactionsModal = ({ isOpen, onClose }) => {
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
            <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-md h-[80vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="p-6 flex justify-end">
                    <button className="flex items-center gap-2 px-6 py-3 bg-slate-700 dark:bg-slate-600 hover:bg-slate-800 dark:hover:bg-slate-500 text-white rounded-full font-medium transition-colors shadow-lg shadow-slate-700/30">
